...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2BH2I4H().pack(_x.portID, _x.reserved0, _x.txReady, _x.mode, _x.baudRate, _x.inProtoMask, _x.outProtoMask, _x.flags, _x.reserved1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.portID, _x.reserved0, _x.txReady, _x.mode, _x.baudRate, _x.inProtoMask, _x.outProtoMask, _x.flags, _x.reserved1,) = _get_struct_2BH2I4H().unpack(str[start:end])
      return self
