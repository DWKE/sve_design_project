...
class VisionMark {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.bool(obj.sign, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VisionMark(null);
    // Deserialize message field [sign]
    data.sign = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisionMark(null);
