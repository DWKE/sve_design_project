...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/soo/sve_design_project/src/lidar_detection/ydlidar)
  set(ydlidar_DEVEL_PREFIX /home/soo/sve_design_project/devel)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/soo/sve_design_project/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'soyeongkim@todo.todo <soyeongkim@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soo/sve_design_project/src/lidar_detection/ydlidar/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;geometry_msgs;pcl_conversions;pcl_ros;sensor_msgs;cv_bridge")
