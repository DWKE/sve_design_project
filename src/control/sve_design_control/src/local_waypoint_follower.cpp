...
void flight_control_cb(const geometry_msgs::PoseStamped::ConstPtr& msg){
...
{
    ros::init(argc, argv, "flight_control_follower");
    ros::NodeHandle nh;
    ros::NodeHandle nh2;
    ...
    ros::Subscriber flight_control_sub = nh2.subscribe<geometry_msgs::PoseStamped>
            ("control/flight_control_", 10, flight_control_cb);
